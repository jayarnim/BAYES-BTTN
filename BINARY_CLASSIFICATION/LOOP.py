...
from LOSS import binary_nll, kl_divergence
...
class Module(nn.Module):
    ...
    def predict(self, tst_loader, n_samples):
        ...
        for Q_idx_batch, V_idx_batch, target_batch in iter_obj:
            ...
            pred_list.extend(probs_batch.cpu().tolist())
    ...
    def _train_epoch(self, trn_loader, epoch):
        ...
        for Q_idx_batch, V_idx_batch, target_batch in iter_obj:
            ...
            # compute loss
            batch_nll_loss = binary_nll(prob_batch, target_batch.float())
